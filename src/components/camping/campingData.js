...
const campingPlaces = [
      {
        ...
        camping: {
          ...
          description:"The Jirisan National Park Camping Site is located in Jirisan Mountain, which straddles Jeollanam-do, Jeollabuk-do, and Gyeongsangnam-do Provinces in South Korea. Jirisan is the second-highest mountain in South Korea and is renowned for its beautiful landscapes, diverse wildlife, and numerous hiking trails.The camping sites in Jirisan National Park offer a serene retreat surrounded by nature, with stunning views of the mountain peaks and valleys. It’s a popular destination for outdoor enthusiasts, hikers, and those looking to experience the natural beauty of South Korea.",
      ...
      },
      {
        ...
        camping: {
          ...
          location: "Gangwon-do",
          description:"The Nami Island Camping Grounds are located on Nami Island, which is in Chuncheon, Gangwon-do Province, South Korea. Nami Island is famous for its picturesque tree-lined paths, especially the iconic Metasequoia Lane, and its natural beauty that changes dramatically with the seasons. It’s a popular tourist destination, known for its vibrant autumn foliage, spring blossoms, and lush summer greenery.",
          ...
          photos: [`${img7}`, `${img8}`, `${img9}`, `${img10}`, `${img11}`, `${img12}`],
        },
      },
      {
        id: 3,
        camping: {
          ...
          location: "Gangwon-do",
          description:"The Seoraksan National Park Camping Site is located in Sokcho, Gangwon-do Province, South Korea. Seoraksan National Park is one of the country’s most famous natural landmarks, known for its stunning granite peaks, lush forests, and diverse wildlife. The park offers various trails for hiking, including the popular Ulsanbawi Rock and Biseondae trails.The camping site in the park allows visitors to enjoy the breathtaking mountain views while being surrounded by nature, making it an ideal spot for hiking, camping, and experiencing the beauty of Seoraksan.",
          ...
          home_page: "camping.com",
          photos: [`${img13}`, `${img14}`, `${img15}`, `${img16}`, `${img17}`, `${img18}`],
        },
      },
      {
        id: 4,
        camping: {
          ...
          home_page: "camping.com",
          photos: [`${img19}`, `${img20}`, `${img21}`, `${img22}`, `${img23}`, `${img24}`],
        },
      },
      {
        id: 5,
        camping: {
          ...
          location: "Incheon",
          description:"The Eulwangri Beach Camping Site is located in Incheon, South Korea. Specifically, it is situated on Eulwangri Beach, which is on Yeongjong Island, near Incheon International Airport. This beach is well-known for its soft white sand, clear waters, and vibrant sunsets, making it a popular destination for beachgoers and campers alike.The area is perfect for relaxing by the seaside, enjoying fresh seafood from nearby restaurants, and exploring other attractions on Yeongjong Island🌅🏖️",
          ...
          home_page: "camping.com",
          photos: [`${img25}`, `${img26}`, `${img27}`, `${img28}`, `${img29}`, `${img30}`],
        },
      },
      {
        id: 6,
        camping: {
          ...
          home_page: "camping.com",
          photos: [`${img31}`, `${img32}`, `${img33}`, `${img34}`, `${img35}`, `${img36}`],
        },
      },
      {
        id: 7,
        camping: {
          ...
          home_page: "camping.com",
          photos: [`${img37}`, `${img38}`, `${img39}`, `${img40}`, `${img41}`, `${img42}`],
        },
      },
      {
        id: 8,
        camping: {
          ...
          home_page: "camping.com",
          photos: [`${img43}`, `${img44}`, `${img45}`, `${img46}`, `${img47}`, `${img48}`],
        },
      },
      {
        id: 9,
        camping: {
          ...
          location: "Gangwon-do",
          description:"The Samtan Art Mine Camping site is located in Jeongseon County, Gangwon-do Province, South Korea. This unique destination combines camping with a cultural experience, as it’s situated near the Samtan Art Mine, a transformed coal mine turned into an art and cultural complex. The area is surrounded by picturesque mountains, making it an ideal spot for art lovers and nature enthusiasts alike.",
          ...
          home_page: "camping.com",
          photos: [`${img49}`, `${img50}`, `${img51}`, `${img52}`, `${img53}`, `${img54}`],
        },
      },
      {
        id: 10,
        camping: {
          ...
          location: "Jeollanam-do",
          description:"The Damyang Metasequoia Camping Site is located in Damyang County, Jeollanam-do Province, South Korea. Damyang is renowned for its lush bamboo forests and the picturesque Metasequoia-lined Road, which is a major attraction near the camping site. This area offers a serene environment, perfect for camping and enjoying the beauty of nature.",
          facilities: ["Restrooms", "BBQ facilities", "Walking paths", "Bicycle rentals"],
          coordinates: {
            latitude: 35.315,
            longitude: 126.999,
          },
          ...
          home_page: "camping.com",
          photos: [`${img55}`, `${img56}`, `${img57}`, `${img58}`, `${img59}`, `${img60}`],
        },
      },
      {
        id: 11,
    ...
    location: "Gangwon-do",
    description:"The Taebaek O2 Resort Camping Site is located in Taebaek, a city in Gangwon-do Province, South Korea. Taebaek is known for its mountainous terrain, including the famous Taebaek Mountain Range, making it a great destination for camping, hiking, and enjoying nature.",
    ...
    coordinates: {
      ...
      longitude: 128.985,
          ...
          home_page: "camping.com",
          photos: [`${img61}`, `${img62}`, `${img63}`, `${img64}`, `${img65}`, `${img66}`],
        },
      },
      {
        id: 12,
        camping: {
          ...
          home_page: "camping.com",
          photos: [`${img67}`, `${img68}`, `${img69}`, `${img70}`, `${img71}`, `${img72}`],
        },
      },
    ];
