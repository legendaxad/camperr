...
import { Belowdiv, Buttonlast, Buttonsa, CArinfo, Datailback, Firstdiv, MainDetaildiv,  SecondDiv,  Updiv } from '../motors/motostyle'
...
import Caravantabs from '../tabs/caravantab';
...
const DetailVcaravan= () => {
    
      const { id } = useParams();
      const car = caravans.find((item) => item.id === parseInt(id));
