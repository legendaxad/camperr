...
import { Buttun, Carinsideinfo, Insidecar, Maincar, Vmenucar} from './caravanstylem'

// import Secondcar from "../../assets/2.svg"
// import Thirdcar from "../../assets/3.svg"
// import Fourcar from "../../assets/4.svg"
// import Fithcar from "../../assets/5.svg"
// import Sixcar from "../../assets/6.svg"
// import Seventhcar from "../../assets/7.svg"
// import Eightcar from "../../assets/8.svg"
// import Ninecar from "../../assets/9.svg"
     ...
     <Vmenucar>
     {
      caravans.map((value , Hmenu)=>{
            return (
                  ...
                  <Link style={{textDecoration:'none'}} to={`/caravan-detail/${value.id}`}>
