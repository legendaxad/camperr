...
import { Bigdiv, Button, Buttond, Buttonsecond, Compare, Fisrtsearch, Foursearch, Homecop, Leftdiv, Leftnavbar, Navtable, Price,    Rightb,  Rightdiv,  Rightnavbar,    Stright,  Table,  } from './motors'
...
setActive (false)
  ...
  return (
   ...
   <Table>
     ...
     <Compare>
     <h3>Compare</h3>
     <div><img src={first} alt="" />
     <img src={second} alt="" />
     <img src={third} alt="" /></div>
     </Compare>
     <Rightb >
     Compare
     </Rightb>
        ...
        >
          ...
          <MenuItem value={30}>90</MenuItem>
                        ...
                        <Foursearch>
                              ...
                              <div style={{borderTopRightRadius:0, borderBottomRightRadius:0,borderTopLeftRadius:5,borderBottomLeftRadius:5}}  ><img onClick={HandleCube} src={cubes} alt="" /></div>
                              <div ><img onClick={Handleline} src={lineone} alt="" /></div>
                        </Foursearch>
                  </Rightnavbar>
            </Navtable>
            {
