...
<form  ref={form} onSubmit={sendEmail}>
    ...
    <button><p>Send question</p></button>
      ...
      <SecondMiddle>
      <form  ref={form} onSubmit={sendEmail}>
    <h2 >Have you got a question</h2><br />
    <Emaildesign>
    <input id="input3" name="user_name"  type="text" placeholder="Your name" /><br />
    <input id="input1" name="user_email" type="text" placeholder="Your email" /><br />
    <textarea name="message" placeholder="Your question"/><br /><br />
    </Emaildesign>
    <button><p>Send question</p></button>
    </form>
