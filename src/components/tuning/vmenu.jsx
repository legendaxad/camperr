...
import {Buttun, Carinsideinfo, Insidecar, Maincar, Vmenucar } from './tuninfstylem'
     ...
     <Vmenucar>
     {
      tuning.map((value , Hmenu)=>{
            return (
                  ...
                  <Link style={{textDecoration:'none'}} to={`/tuning-detail/${value.id}`}>
...
export default Tuningcomponentv