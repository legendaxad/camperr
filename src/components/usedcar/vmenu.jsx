...
const UsedcomponentV = ({ searchData }) => {
  const caheckedData = usedVehicles.filter((data) =>
    data.car.name.toLocaleLowerCase().includes(searchData.toLowerCase())
  );
